...
module.exports = {
  ...
  execute(message, args) {
    if (
          ...
          .then(function (result) {
            ...
            const status = new Discord.MessageEmbed()
              ...
              .addField(
                "[Steam] Apex Login",
                `${getStatus(
                  result.ApexOauth_Steam["EU-West"].Status
                )}EU West (${
                  ...
                  result.ApexOauth_Steam["Asia"].Status
                )}Asia (${result.ApexOauth_Steam["Asia"].ResponseTime}ms)`,
                true
              )
              .setFooter(
      ...
      console.log(
        "This user cannot do that command because they dont have the correct roles."
      );
      return;
    }
  },
