...
module.exports = {
  name: "compactevent",
  description: "The event command, but compact.",
  execute(message) {
    ...
    connection.getConnection(function (err, connection) {
      ...
      connection.query(query, function (err, results) {
        ...
        const eventEmbed = new Discord.MessageEmbed()
          ...
          .addField(
            ...
            `${DateTime.fromISO(event.eventEnd, {
              ...
              "cccc LLLL d, yyyy\nhh:mm a ZZZZ"
            )}\n[Countdown in Your Timezone](${getCountdownURL(event.eventEnd)})`,
            true
          )
          .addField(
            "Countdown",
            `The **${event.eventName} Event** will end **${time(realDateMath)}**`
          );
        ...
        const preEventEmbed = new Discord.MessageEmbed()
          ...
          .addField(
            "Countdown",
            `The **${event.eventName} Event** will start in **${time(timeTillDate)}**`
          );
