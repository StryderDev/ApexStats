...
module.exports = {
	...
	async execute(interaction) {
		// const text = `The **Control LTM** is not currently active. Check back when Control is set to return in the future!`;
		...
		await axios
			...
			.then(response => {
				...
				const mapEmbed = new MessageEmbed()
					...
					.setColor('2F3136')
					.setImage(`https://cdn.apexstats.dev/Bot/Maps/Season13/Control/${encodeURIComponent(control.current.map)}.png`);
