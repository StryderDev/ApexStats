...
module.exports = {
	...
	run: async (client, interaction, args) => {
		...
		try {
			...
			console.error(chalk`{red.bold [${timeLogs}] Error: ${error.code} on Status API in Status Command.}`);
			await interaction.followUp({
				content: 'There was an error loading the Status API. Try again in a few minutes.',
			});
		}
	},
};
