...
module.exports = {
	...
	async execute(interaction) {
		...
		await axios
			...
			.catch(err => {
				console.error(`${chalk.red.bold('[APEXSTATS_STATS]')} Axios error: ${err.message}`);

				const statsContainer = new ContainerBuilder().addTextDisplayComponents(textDisplay => textDisplay.setContent(`# Player Lookup Error\n${err.response.data.error}`));
