...
client.once("ready", () => {
  function updateStatus() {
    axios
      .get(`https://api.mozambiquehe.re/servers?auth=${config.MozambiqueAPI}`)
      .then((res) => {
        ...
        const statusEmbed = new Discord.MessageEmbed()
          ...
          .addField(
            ...
            `${getStatus(originResult["EU-West"].Status)}EU West (${
              ...
              originResult["SouthAmerica"].Status
            )}South America (${
          ...
          .addField(
            ...
            `${getStatus(novaResult["EU-West"].Status)}EU West (${
              ...
              novaResult["SouthAmerica"].Status
            )}South America (${
        ...
        .addField(
          ...
          .addField(
            ...
            `${getStatus(OauthSteam["EU-West"].Status)}EU West (${
              ...
              OauthSteam["SouthAmerica"].Status
            )}South America (${
        ...
        try {
          ...
          channel.messages
            .fetch(config.autoUpdate.status.message)
            .then((msg) => {
